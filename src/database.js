...
class DB {
  ...
  seedData() {
    ...
    const defaultConfig = [
      ...
      ['factus_client_id',     'FACTUS_CLIENT_ID_PLACEHOLDER'],
      ['factus_client_secret', 'FACTUS_CLIENT_SECRET_PLACEHOLDER'],
      ['factus_username',      'FACTUS_USERNAME_PLACEHOLDER'],
      ['factus_password',      'FACTUS_PASSWORD_PLACEHOLDER'],
      ['factus_rango_id',      ''],
    ];
