...
export function prepararInicializacionConfiguracion(entrada: EntradaInicializacionConfiguracion): ConfiguracionEmpresa {
  ...
  return crearPlantillaConfiguracionRevision1({ empresaId: entrada.empresaId, nombreComercial: entrada.nombreComercial, creadaEn: FieldValue.serverTimestamp(), actualizadaEn: FieldValue.serverTimestamp(), modulosIniciales: entrada.modulosIniciales, vertical: entrada.vertical, ultimaMutacion: { actorTipo: "SYSTEM", actorId: "system", origen: entrada.origen, commandId: entrada.commandId, correlationId: entrada.correlationId } });
}
/**
...
export interface EntradaInicializacionConfiguracion { empresaId: string; nombreComercial: string; paisFiscal: string; commandId: string; correlationId: string; origen: "BOOTSTRAP" | "BACKFILL"; modulosIniciales?: readonly string[]; vertical?: import("../../../lib/configuracion").VerticalTenant }
