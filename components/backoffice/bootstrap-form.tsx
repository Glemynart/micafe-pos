  ...
  return (
    <>
      ...
      <Card className="mx-auto max-w-3xl">
        <CardHeader><CardTitle>Datos de la solicitud</CardTitle><CardDescription>El owner debe existir previamente en Firebase Auth y el plan/version debe estar publicado.</CardDescription></CardHeader>
        <CardContent>
