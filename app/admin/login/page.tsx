            ...
            <div>
              ...
              <form onSubmit={handleLogin} className={`space-y-4 ${sesionNoAdmin ? 'opacity-30 pointer-events-none select-none' : ''}`}>
                <div className="space-y-2">
                  <label htmlFor="user" className="text-sm font-medium text-white/70">Código operativo</label>
                  <input
                    id="user"
                ...
                <div className="space-y-2">
                  <label htmlFor="pass" className="text-sm font-medium text-white/70">PIN de 6 dígitos</label>
