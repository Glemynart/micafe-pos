  ...
  return (
    <div className="pb-4">
      ...
      <div className="px-4 pt-5 pb-4 border-b border-slate-100 bg-white">
        <h1 className="text-xl font-bold text-slate-900">Espacios</h1>
      ...
      <div className="px-4 pt-4 space-y-3">
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden divide-y divide-slate-100">
          {espacios.length === 0 && (
            <p className="text-sm text-slate-400 text-center py-10">No hay espacios registrados</p>
          )}
          {espacios.map((e) => (
            <div
              key={e.id}
            ...
            >
              ...
              <button
                ...
                className={cn(
                  ...
                  e.activo ? "bg-emerald-500" : "bg-slate-200"
                )}
              >
                {guardando === e.id ? (
