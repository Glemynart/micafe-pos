...
| Function Wompi desplegada | BLOCKED | `firebase functions:list --project micafe-pos --json` no contiene `wompiReservasWebhookV1`; no existe evidencia de endpoint desplegado. |
...
| Smoke productivo | BLOCKED — PRODUCTIVE SMOKE REQUIRES AUTHORIZED WINDOW | No se ejecutaron pagos ni escrituras productivas. |
