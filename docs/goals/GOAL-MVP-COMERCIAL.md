...
- **Estado:** ACTIVO.
 ...
 - **PR completados:** PR #147, PR #149, PR #151, PR #153, PR #155, PR #157, PR #159, PR #161, PR #163, PR #165, PR #167, PR #168, PR #170, PR #172, PR #174, PR #175, PR #176, PR #178, PR #179, PR #181, PR #182 y PR #183, PR #184, PR #193, PR #194, PR #195, PR #196, PR #197, PR #199, PR #201, PR #203, PR #204, PR #205 y PR #207 — se añade B3-B de Eventos tenant-aware: backfill Emulator-only, idempotencia, preservación de snapshots y evidencia sin escrituras productivas. El cierre productivo de B3 permanece condicionado.
  ...
  PR #226 quedó añadido a los PR completados: ADR-SAAS-026 fue aceptado y el mecanismo de cierre controlado y recuperable de Eventos legacy quedó integrado y certificado en Emulator/CI, con allowlist estricta, journal, recovery, idempotencia y `productionWrites: false`, sin eliminación productiva. PR #229 quedó integrado con ADR-SAAS-027 aceptado y el operador productivo independiente B3-027, protegido por proyecto/bucket fijos, manifiesto externo exacto, recovery, journal, precondiciones por objetivo y confirmación interactiva fuera de CI; el operador no se ha ejecutado.
 - **Siguiente PR recomendado:** preparar el dry-run productivo read-only de B3-026 con el manifiesto externo congelado y los cuatro targets exactos ya confirmados; validar hashes, referencias, drift, recovery y `productionWrites: false`, y detenerse antes de cualquier eliminación. La ejecución destructiva seguirá siendo un gate independiente que requiere autorización operativa explícita. El operador B3-027 ya está integrado y disponible, pero no debe ejecutarse automáticamente. Reservas-Wompi, impresión física, DIAN, Wompi, offline y notificaciones permanecen como seguimientos separados; `P0-07 / E3.1` continúa bloqueado por hardware/canal.
- **Milestone activo:** `M4 — Certificación comercial`.
 - **Epic activo:** `E4.2 — Release readiness` permanece EN PROGRESO con PR #229 integrado; Storage, B1, B2, B3-A, B3-B, ADR-SAAS-026 y ADR-SAAS-027 están implementados y certificados sin producción, Operator Portal y R1-A Web/PWA están integrados como gates CI, y la CI post-merge de `main @ a4a1d90bc3f52b564d949db0cb3f483abebe45ac` está completamente verde. El siguiente corte es el dry-run productivo read-only del manifiesto externo exacto; cualquier eliminación queda fuera y requiere autorización explícita separada. `E4.1 — Certificación integral` está COMPLETADO. `M3` conserva `E3.1 — Impresión física` como gate externo BLOQUEADO por hardware/canal y `E3.2` queda COMPLETADO como decisión Web/PWA-only.
