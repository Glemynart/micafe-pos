...
- La auditoría posterior identificó mutaciones cliente históricas en reservas internas y agenda. `ADR-SAAS-033` fue aceptado para migrar cancelación y completado a Functions con saga DEMO idempotente; PR de implementación y verificación siguen pendientes.
...
- **Estado:** ACTIVO.
- **Post-merge:** PR #322 quedó fusionado en `origin/main @ 70d2035c0dc1df706e21a625d0728e306d42b690` tras CI y Vercel verdes; el cutover server-authoritative de inventario, ajustes y mermas quedó integrado sin escrituras productivas.
- **Siguiente PR técnico:** integrar `ADR-SAAS-033` y las Functions/cliente/Rules de reservas internas. Recovery y smoke productivo siguen siendo gates independientes antes de cualquier transición productiva de Café Atrato.
- **PR completados:** #246, #247, #248, #249, #250, #251, #252, #253, #256, #257, #258, #260, #262, #263, #264, #265, #266, #267, #269, #270, #271, #272, #273, #274, #275, #276, #278, #279, #280, #281, #282, #284, #285, #286, #287, #289, #290, #291, #292, #294, #296, #298, #299, #300, #301, #303, #305, #307, #309, #311, #313, #315, #317, #318, #322.
- **Siguiente PR esperado:** observar el primer backup generado por el schedule diario; ejecutar después el restore a `gsaas02-recovery-20260814`, verificar integridad y aislamiento, medir RPO/RTO y publicar la atestación independiente. También conseguir una cuenta/ventana segura para el smoke productivo. Con esos gates, ejecutar el preflight anticipado y el cierre canónico de la raíz; después materializar la relación anual de Café Atrato, preservar la suscripción histórica, activar las nueve capacidades y publicar evidencia. No se autoriza ninguna escritura de tenant mientras recovery o el smoke productivo independiente sigan pendientes.
