...
certificación tenant-aware. B1, B2, B3-A y B3-B de Eventos tenant-aware quedaron integrados bajo ADR-SAAS-025; ADR-SAAS-026 y PR #226 integraron el mecanismo de cierre controlado y recuperable. B3-027 ejecutó después el cierre productivo autorizado de los cuatro targets exactos; el journal, recovery y evidencia externa quedaron verificados, y el asset excluido permanece intacto. El cierre técnico/documental y la corrección del round-trip JSON del recovery quedan en el PR actual.
