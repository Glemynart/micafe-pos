...
- **Excepción paralela propuesta — P2-05:** ADR-SAAS-038 propone recuperar de forma controlada F1–F4 de la integración administrativa POS → Dusema sobre el `main` vigente, usando los commits históricos solo como fuente de contenido. No modifica el resultado comercial, Milestone, Epic ni criterios de aceptación de G-SAAS-02; no autoriza configuración externa, secrets, bindings reales, provisioning, despliegue ni pruebas E2E.
