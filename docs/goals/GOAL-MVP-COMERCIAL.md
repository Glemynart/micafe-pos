...
- **Rama base:** `main @ 65f9fa00a1cfaa4eddd5395e7bceeaa9d952218d`
...
- **Siguiente PR técnico:** continuar la auditoría read-only y la siguiente remediación POS crítica demostrada en `origin/main`; recovery y smoke productivo siguen siendo gates independientes antes de cualquier transición productiva de Café Atrato.
- **PR completados:** #246, #247, #248, #249, #250, #251, #252, #253, #256, #257, #258, #260, #262, #263, #264, #265, #266, #267, #269, #270, #271, #272, #273, #274, #275, #276, #278, #279, #280, #281, #282, #284, #285, #286, #287, #289, #290, #291, #292, #294, #296, #298, #299, #300, #301, #303, #305, #307, #309, #311, #313, #315, #317, #318, #322, #323, #326.
- **Siguiente PR esperado:** observar el primer backup generado por el schedule diario; ejecutar después el restore a `gsaas02-recovery-20260814` con un principal que tenga permisos de recovery, verificar integridad y aislamiento, medir RPO/RTO y publicar la atestación independiente. También conseguir una cuenta/ventana segura para el smoke productivo. Con esos gates, ejecutar el preflight anticipado y el cierre canónico de la raíz; después materializar la relación anual de Café Atrato, preservar la suscripción histórica, activar las nueve capacidades y publicar evidencia. No se autoriza ninguna escritura de tenant mientras recovery o el smoke productivo independiente sigan pendientes.
