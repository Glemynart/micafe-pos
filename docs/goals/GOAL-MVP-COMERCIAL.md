...
- **Estado:** ACTIVO.
  ...
  E4.2 mantiene como siguiente corte el dry-run productivo read-only de B3-026, condicionado a los cuatro targets exactos del manifiesto externo y sin datos inventados; toda eliminación productiva queda fuera y requiere autorización explícita separada.
 ...
 - **PR completados:** PR #147, PR #149, PR #151, PR #153, PR #155, PR #157, PR #159, PR #161, PR #163, PR #165, PR #167, PR #168, PR #170, PR #172, PR #174, PR #175, PR #176, PR #178, PR #179, PR #181, PR #182 y PR #183, PR #184, PR #193, PR #194, PR #195, PR #196, PR #197, PR #199, PR #201, PR #203, PR #204, PR #205 y PR #207 — se añade B3-B de Eventos tenant-aware: backfill Emulator-only, idempotencia, preservación de snapshots y evidencia sin escrituras productivas. El cierre productivo de B3 permanece condicionado.
  ...
  PR #226 queda añadido a los PR completados: ADR-SAAS-026 fue aceptado y el mecanismo de cierre controlado y recuperable de Eventos legacy quedó integrado y certificado en Emulator/CI, con allowlist estricta, journal, recovery, idempotencia y `productionWrites: false`. La eliminación productiva no fue ejecutada y continúa requiriendo un manifiesto congelado externo, un dry-run read-only final y autorización explícita separada.
 - **Siguiente PR recomendado:** no se abre un PR funcional nuevo hasta completar el dry-run productivo read-only de B3-026 con los cuatro targets exactos del manifiesto B3-A revisado. El manifiesto productivo no está versionado en el repositorio ni puede sustituirse por fixtures o datos inventados; el dry-run debe detenerse antes de cualquier eliminación. La ejecución destructiva seguirá siendo un gate independiente. B2 no modificó `customDomain`, reservas, marketing ni landing fuera de la lectura pública. Operator Portal/R1A Web/PWA ya están cubiertos por PR #211; reservas-Wompi, impresión física, DIAN, Wompi, offline y notificaciones permanecen como seguimientos separados. `P0-07 / E3.1 — certificación física de impresión` permanece como gate externo bloqueado por hardware/canal.
- **Milestone activo:** `M4 — Certificación comercial`.
 - **Epic activo:** `E4.2 — Release readiness` permanece EN PROGRESO con PR #226 integrado; Storage, B1, B2, B3-A, B3-B y el mecanismo de cierre controlado de Eventos legacy están certificados sin producción, Operator Portal y R1-A Web/PWA están integrados como gates CI, el smoke P0-01/E4.1 está estabilizado y E4.2-SEC-002A deja en cero las vulnerabilidades productivas criticas y altas. El siguiente corte es el dry-run productivo read-only condicionado a la disponibilidad del manifiesto externo exacto; cualquier eliminación queda fuera y requiere autorización explícita separada. `E4.1 — Certificación integral` está COMPLETADO. `M3` conserva `E3.1 — Impresión física` como gate externo BLOQUEADO por hardware/canal y `E3.2` queda COMPLETADO como decisión Web/PWA-only.
...
certificación tenant-aware. B1, B2, B3-A y B3-B de Eventos tenant-aware quedaron integrados bajo ADR-SAAS-025; ADR-SAAS-026 y PR #226 integraron el mecanismo de cierre controlado y recuperable. El siguiente trabajo es el dry-run productivo read-only, condicionado al manifiesto externo exacto; cualquier eliminación requiere autorización explícita posterior y no se ejecutó en PR #226.
