...
- **PR completados:** #246, #247, #248, #249, #250, #251, #252, #253, #256, #257, #258, #260, #262, #263, #264, #265, #266, #267, #269, #270, #271, #272, #273, #274, #275, #276, #278, #279, #280, #281, #282, #284, #285, #286, #287, #289, #290, #291, #292, #294, #296, #298, #299, #300, #301, #303, #305, #307, #309, #311, #313, #315, #317, #318, #322, #323, #326, #334, #335.
...
- **Siguiente PR esperado:** conseguir una cuenta/ventana segura para el smoke productivo autenticado y repetir el preflight read-only contra `origin/main @ c25960e64cf1841abd19fc3f2fa609f450444ee6`. Después, y solo con ventana histórica resuelta, autenticación de operador y todos los gates en PASS, ejecutar el cierre canónico aprobado, materializar la relación ANUAL de 30 días de Café Atrato, activar sus nueve capacidades y publicar la evidencia. No se autoriza ninguna escritura de tenant mientras el smoke o la autenticación del operador sigan pendientes.
