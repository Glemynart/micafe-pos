...
- **Estado:** ACTIVO.
- **PR completados:** #246, #247, #248, #249, #250, #251, #252, #253, #256, #257, #258, #260, #262, #263, #264, #265, #266, #267, #269, #270, #271, #272, #273, #274, #275, #276, #278, #279, #280, #281, #282, #284, #285, #286, #287, #289, #290, #291, #292, #294, #296, #298, #299, #300, #301, #303, #305, #307, #309, #311, #313, #315, #317.
- **Siguiente PR esperado:** observar el primer backup generado por el schedule diario; ejecutar después el restore a `gsaas02-recovery-20260814`, verificar integridad y aislamiento, medir RPO/RTO y publicar la atestación independiente. En paralelo, completar la autenticación Firebase del operador y conseguir una cuenta/ventana segura para el smoke productivo. Con esos gates, ejecutar el preflight anticipado y el cierre canónico de la raíz; después materializar la relación anual de Café Atrato, preservar la suscripción histórica, activar las nueve capacidades y publicar evidencia. No se autoriza ninguna escritura de tenant mientras recovery y autenticación sigan pendientes.
