...
Los Milestones M1–M4 reorganizan la prioridad P0 sin cambiar su alcance. P0-02 conserva su gate fiscal para operación FISCAL/productiva, mientras ADR-SAAS-020 habilita P0-04 en paralelo para la operación DEMO no fiscal sin datos del cliente ni escrituras productivas.

## Milestones y Epics

### M1 — Tenant y fiscalidad listos para operar — CONDICIONAL
...
### M2 — Núcleo transaccional íntegro — ACTIVO
...
| E2.3 Cobro y anulación | Efectivo, transferencia, mixto, crédito y anulación certificados sin duplicados. | P0-04 | EN IMPLEMENTACIÓN |
