...
- **Estado:** ACTIVO.
  ...
  PR #194 quedó integrado en `main @ 91d9e5b` con E4.2: auditoría de release readiness, contrato y runner de evidencia solo lectura, CI conectado, decisión de release CONDICIONAL y registro de cinco seguimientos técnicos y seis gates externos pendientes. ADR-SAAS-024 fue aceptado con el modelo de Storage completamente tenant-aware; su ejecución queda separada en PR A / P2-03 (Storage) y PR B posterior (Eventos tenant-aware), sin mezclar fronteras ni modificar Firestore en PR A.
   PR #195 quedó integrado en `main @ f5200ab` con PR A / P2-03: contrato tenant-aware de Firebase Storage, `storage.rules` deny-by-default, aislamiento por `empresaId`, rutas nuevas para productos y assets públicos, Storage Emulator/CI, evidencia automática y cierre del seguimiento de Storage de E4.2. ADR-SAAS-025 fue aceptado y PR #196 quedó integrado en `main @ 6428f93` con B1: contrato Firestore tenant-aware de Eventos, aislamiento administrativo por tenant, consultas filtradas, servicio, UI administrativa, índice y pruebas multi-tenant. B2 (lectura pública contextualizada) y B3 (transición legacy) permanecen separados.
 - **PR completados:** PR #147, PR #149, PR #151, PR #153, PR #155, PR #157, PR #159, PR #161, PR #163, PR #165, PR #167, PR #168, PR #170, PR #172, PR #174, PR #175, PR #176, PR #178, PR #179, PR #181, PR #182 y PR #183, PR #184, PR #193, PR #194, PR #195, PR #196 — se añade B1 de Eventos tenant-aware sobre Firestore, con ADR-SAAS-025 aceptado, Rules, servicio, UI administrativa, índice y pruebas multi-tenant. B2 y B3 permanecen separados.
 ...
 - **Siguiente PR recomendado:** preparar B2 de Eventos tenant-aware: lectura pública contextualizada por slug/dominio, resolución server-side a `empresaId`, integración de la landing y pruebas de aislamiento. No incluye B3, backfill ni retiro de documentos legacy. No implica escrituras en producción hasta autorización. Las superficies Operator Portal/R1A/Electron/reservas-Wompi, impresión física, DIAN, Wompi, offline y notificaciones permanecen como seguimientos separados. `P0-07 / E3.1 — certificación física de impresión` permanece como gate externo bloqueado por hardware/canal.
- **Milestone activo:** `M4 — Certificación comercial`.
 - **Epic activo:** `E4.2 — Release readiness` permanece EN PROGRESO con PR #196 integrado; Storage y B1 de Eventos tenant-aware están certificados y el release mantiene como siguiente corte B2, junto con seguimientos de dependencias y superficies externas. `E4.1 — Certificación integral` está COMPLETADO. `M3` conserva `E3.1 — Impresión física` como gate externo BLOQUEADO por hardware/canal y `E3.2` como condicional.
...
certificación tenant-aware. El siguiente trabajo es preparar B2 / Eventos
