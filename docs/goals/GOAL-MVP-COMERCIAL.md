...
- **Siguiente PR esperado:** `P0-04 / E2.3 — certificar cobro de mostrador y anulación después del cierre de P0-02/E1.2; P0-03 y P0-05 ya están integrados, pero este PR no puede iniciarse legítimamente hasta que Café Atrato complete su readiness fiscal o se apruebe un cambio explícito de secuencia y alcance. No queda actualmente otro PR P0 independiente que pueda ejecutarse en paralelo sin romper las dependencias del roadmap.`
- **Milestone activo:** `M1 — Tenant y fiscalidad listos para operar`.
- **Epic activo:** `E1.2 — Readiness fiscal`.

La provisión productiva aprobada, la verificación automatizada y la evidencia manual de login, resolución del tenant y visibilidad de UI/Rules completan P0-01/E1.1. La ruta DEMO permite evaluar el POS durante el Trial sin datos fiscales ficticios; el cierre de P0-02/E1.2 sigue condicionado a datos fiscales reales aprobados y confirmación explícita antes de cualquier escritura productiva. P0-05/E2.2 y P0-06/E2.4 quedaron integrados sin migrar ni reescribir cuentas productivas; P0-06 certifica apertura, venta DEMO, egreso, faltante, sobrante, relevo, cierre y replay en dos tenants aislados. P0-10/E3.3 quedó integrado con una certificación reusable de exportación/importación Firestore y Auth en Emulator, incluyendo huella de snapshot y aislamiento multi-tenant. El Goal queda temporalmente detenido en la dependencia operativa de P0-02/E1.2: el siguiente trabajo funcional legítimo es P0-04/E2.3 una vez exista readiness fiscal aprobada; no se adelantan P0-07, P0-08 ni P0-09 porque dependen de esa secuencia y de decisiones/hardware posteriores.
