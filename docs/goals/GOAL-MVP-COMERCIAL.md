...
- **Progreso:** metodología Goal adoptada sobre la baseline `main @ f66016e`; ningún criterio P0 se da por certificado solo por existir implementación previa.
- **Estado:** ACTIVO.
- **PR completados:** ninguno bajo `G-MVP-01` todavía.
