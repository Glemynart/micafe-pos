...
- **Siguiente PR esperado:** `ADR-SAAS-017 — recuperación segura de credenciales de administrador y operadores; trabajo transversal reusable, sin escrituras productivas, en paralelo al cierre de readiness fiscal de E1.2`.
