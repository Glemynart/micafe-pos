...
- **Siguiente PR esperado:** conseguir una cuenta/ventana segura para el smoke productivo autenticado y repetir el preflight read-only contra `origin/main @ 6b6a54df3216abd5c42c2bd3f5d2c5ad70d4ef4f`. Después, y solo con ventana histórica resuelta, autenticación de operador y todos los gates en PASS, ejecutar el cierre canónico aprobado, materializar la relación ANUAL de 30 días de Café Atrato, activar sus nueve capacidades y publicar la evidencia. No se autoriza ninguna escritura de tenant mientras el smoke o la autenticación del operador sigan pendientes.
