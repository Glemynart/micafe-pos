...
- **Estado:** ACTIVO.
> **Reconciliación vigente (2026-08-11):** la mención histórica de P0-08/E3.2 como dependiente de canal o hardware queda supersedida por la decisión Web/PWA-only y PR #224; P0-08 no es trabajo ejecutable. B3-027 está cerrado y la documentación viva fue reconciliada por PR #237 en `main @ fabcf65`.
