...
- **Estado:** ACTIVO.
  ...
  PR #195 quedó integrado en `main @ f5200ab` con PR A / P2-03: contrato tenant-aware de Firebase Storage, `storage.rules` deny-by-default, aislamiento por `empresaId`, rutas nuevas para productos y assets públicos, Storage Emulator/CI, evidencia automática y cierre del seguimiento de Storage de E4.2. PR B de Eventos permanece independiente y no fue adelantado.
- **PR completados:** PR #147, PR #149, PR #151, PR #153, PR #155, PR #157, PR #159, PR #161, PR #163, PR #165, PR #167, PR #168, PR #170, PR #172, PR #174, PR #175, PR #176, PR #178, PR #179, PR #181, PR #182 y PR #183, PR #184, PR #193, PR #194, PR #195 — reconciliación, cierre documental, referencia vigente de ADR-SAAS-013, tooling de certificación P0-01, comando Trial para una Empresa existente, plan SaaS genérico reusable del MVP con `shifts`, capacidades del Plan disponibles para la configuración B1, smoke E2E P0-01 alineado a la oferta y navegación aprobadas, Fase 2 de ventas server-authoritative, eliminación de escrituras financieras legacy desde el cliente, certificación manual del tenant real, ventas DEMO no fiscales durante Trial, aceptación de ADR-SAAS-017 y su planificación como P0-11/E3.4, aceptación de ADR-SAAS-018 para eventos operativos confiables, recuperación segura de credenciales de administrador y operadores, aceptación de ADR-SAAS-019, compatibilidad financiera tenant-aware, certificación reusable P0-06 de turnos y arqueo multi-tenant con Emulator, certificación reusable P0-10 de exportación/importación de Firestore y Auth Emulator con fixtures multi-tenant y huella de restauración, liquidación server-authoritative de cuentas por cobrar con reversión auditable y P1-04/E2.7 con operaciones de salón y cocina server-authoritative. Las notificaciones se mantienen separadas para un PR posterior. El PR #184 añade transporte reutilizable de impresión con fallback PWA y pruebas de seguridad del renderer. El PR #185 sincroniza el estado bloqueado de P0-07 por dependencia de hardware y canal. El PR #191 fortalece el release gate reusable con CI, preflight y smoke E2E. El PR #192 cierra la autoridad server-side de salón y cocina con certificación reusable multi-tenant. El PR #193 añade la certificación integral E4.1 reusable con evidencia Emulator/CI y gates externos explícitos. El PR #194 añade la auditoría E4.2, evidencia de release y registro de seguimientos sin ampliar el dominio. El PR #195 cierra el contrato de Storage tenant-aware y su certificación reusable sin migrar Eventos en Firestore.
...
- **Siguiente PR recomendado:** preparar el PR B de Eventos tenant-aware como iniciativa independiente: estrategia de transición legacy, `empresaId` en documentos nuevos, consultas tenant-aware, permisos y UI, sin implementarlo dentro de P2-03 ni retirar todavía el modelo global. El PR B requiere su propia auditoría de compatibilidad y migración; no implica escrituras en producción hasta autorización. Las vulnerabilidades de dependencias y las superficies Operator Portal/R1A/Electron/reservas-Wompi quedan como seguimientos separados. `P0-07 / E3.1 — certificación física de impresión` permanece como gate externo bloqueado y requiere impresora térmica real y decisión del canal de caja. P0-02/P0-09 siguen como gate fiscal condicional y P0-08/E3.2 como decisión condicional de canal. Impresión física, Electron, DIAN, Wompi, offline y notificaciones permanecen fuera de E4.2 y requieren sus gates o trabajos posteriores correspondientes. `P1-05` no se recomienda todavía: su alcance histórico mezcla crédito/cobranza avanzada con la decisión aprobada de `cuentas_cobro` operativa y requiere reconciliación antes de abrir un PR.
- **Milestone activo:** `M4 — Certificación comercial`.
- **Epic activo:** `E4.2 — Release readiness` permanece EN PROGRESO con PR #195 integrado; Storage tenant-aware está certificado y el release mantiene seguimientos de dependencias y superficies externas. `E4.1 — Certificación integral` está COMPLETADO. `M3` conserva `E3.1 — Impresión física` como gate externo BLOQUEADO por hardware/canal y `E3.2` como condicional.
...
certificación tenant-aware. El siguiente trabajo es preparar PR B / Eventos
tenant-aware como iniciativa separada; cualquier ampliación funcional deberá
pasar primero por la jerarquía Goal → Milestone → Epic → PR.
