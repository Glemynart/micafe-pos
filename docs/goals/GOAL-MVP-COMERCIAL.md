...
el siguiente trabajo recomendado es PR A / P2-03, limitado al contrato seguro de
Firebase Storage y su certificación tenant-aware. PR B / Eventos tenant-aware
deberá mantener una iniciativa separada; cualquier ampliación funcional deberá
